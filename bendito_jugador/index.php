...
<body class="auth-body">
    <main class="login-shell">
        <section class="login-showcase">
            <img src="<?= app_url('assets/img/bendito_jugador_logo.png'); ?>" alt="Bendito Jugador" style="display: block; max-width: 430px; width: 100%; height: auto; object-fit: contain; margin-bottom: 24px;">
        ...
        <section class="login-panel">
            <div class="login-card">
                <div class="login-brand">
                    <img src="<?= app_url('assets/img/bendito_jugador_icono.png'); ?>" alt="Bendito Jugador" style="width: 52px; height: 52px; object-fit: contain; flex-shrink: 0;">
                    <div>
                        <span class="login-brand__eyebrow">BENDITO JUGADOR</span>
